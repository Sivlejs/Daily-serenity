...
export const breathingExercises: BreathingExercise[] = [
  ...
  },
  {
    ...
    prompts: {
      ...
      hold: 'Pause at the top, savoring the fullness',
  ...
  },
  {
    ...
    description: 'Breathe at five breaths per minute to synchronize heart rate and nervous system.',
    inhale: 6,
    hold: 0,
    exhale: 6,
    cycles: 5,
    benefit: 'Harmonizes heart, lungs and nervous system',
    prompts: {
